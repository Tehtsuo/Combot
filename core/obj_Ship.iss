...
objectdef obj_Ship inherits obj_State
{
	...
	method Initialize(int64 ID)
	{
		...
		This:AddModuleList[MiningLaser, "ToItem.GroupID = GROUP_MININGLASER || ToItem.GroupID = GROUP_STRIPMINER || ToItem.GroupID = GROUP_FREQUENCYMININGLASER || ToItem.GroupID = GROUP_GASCLOUDHARVESTER"]
